...
/**
 * [OrderViewModel] holds information about a cupcake order in terms of quantity, flavour, and pickup date.
...
class OrderViewModel : ViewModel() {
     ...
     *
     * @param numberOfCupcakes to order
     */
     ...
     * The SimpleDateFormat class is used to format and parse dates in a locale-sensitive manner.
     */
